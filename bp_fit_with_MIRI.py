...
fit_with_MIRI = False # Whether or not to use MIRI coverage and convolve everything to F770W
...
for i, filt in enumerate(filters):
    ...
    else: data[i, :, :], sigma[i, :, :], bkg[i], sr_pix[i] = o.get_mosaic_cut(filt, n=Ncut)

snr = data / sigma # For pixel masking and error floor
